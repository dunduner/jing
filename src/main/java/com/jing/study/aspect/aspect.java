...
public class aspect {
     ...
     */
    @Pointcut("@annotation(com.jing.study.annotation.OperLog)")
     ...
     */
    @Pointcut("execution(* com.jing.study.controller..*.*(..))")
...
//        operlog.setOperMethod(methodName); // 请求方法
        ...
        System.out.println("paramsJson:" + params);
...
//        operationLogService.insert(operlog);//保存日志到库
