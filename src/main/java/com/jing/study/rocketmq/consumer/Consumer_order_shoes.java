 ...
 * 未按照顺序消费----
 */
public class Consumer_order_shoes {

    public static void main(String[] args) throws InterruptedException, MQClientException {
        // 实例化消费者
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("zhangning_tongbu_consumer_shoes");
        // 设置NameServer的地址
        String nameServer = "localhost:9876";
        consumer.setNamesrvAddr(nameServer);

        // 订阅一个或者多个Topic，以及Tag来过滤需要消费的消息
        consumer.subscribe("RMQ_A2B_XXX_ORDER_DEV", "tag_shoes");
